...
namespace Schools.Infra.Data.Migrations
{
    ...
    [Migration("20200905195144_Addd_Rules")]
    partial class Addd_Rules
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Schools.Domain.Models.AboutUs.AboutUs", b =>
                {
            ...
            modelBuilder.Entity("Schools.Domain.Models.ContactUs.ContactUs", b =>
                {
            ...
            modelBuilder.Entity("Schools.Domain.Models.ContactUs.ContactUsForm", b =>
                {
                    b.Property<int>("ContactId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Schools.Domain.Models.Schools.RequestGallery", b =>
                {
                    ...
                    b.ToTable("RequestGalleries");
                });

            modelBuilder.Entity("Schools.Domain.Models.Schools.Rules", b =>
                {
            ...
            modelBuilder.Entity("Schools.Domain.Models.Schools.SchoolRequest", b =>
                {
                    b.Property<int>("RequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("DocumentsImage")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Schools.Domain.Models.Schools.RequestGallery", b =>
                {
                    b.HasOne("Schools.Domain.Models.Schools.SchoolRequest", "SchoolRequest")
                        .WithMany("Galleries")

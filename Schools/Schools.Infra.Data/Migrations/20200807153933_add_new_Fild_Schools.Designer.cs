...
namespace Schools.Infra.Data.Migrations
{
    ...
    [Migration("20200807153933_add_new_Fild_Schools")]
    partial class add_new_Fild_Schools
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Schools.Domain.Models.Blogs.Blog", b =>
                {
                    ...
                    b.Property<int?>("BlogGroupGroupId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BlogGroupGroupId");

                    b.HasIndex("BlogTypeTypeId");
            ...
            modelBuilder.Entity("Schools.Domain.Models.Schools.Locations.Area", b =>
                {
            ...
            modelBuilder.Entity("Schools.Domain.Models.Schools.SchoolComment", b =>
                {
                    ...
                    b.Property<int?>("SchoolCommentCommentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SchoolCommentCommentId");
            ...
            modelBuilder.Entity("Schools.Domain.Models.Blogs.Blog", b =>
                {
                    b.HasOne("Schools.Domain.Models.Blogs.BlogGroup", "BlogGroup")
                        .WithMany("Blog")
                        .HasForeignKey("BlogGroupGroupId");

                    b.HasOne("Schools.Domain.Models.Blogs.BlogType", "BlogType")
                        .WithMany("Blogs")
                        .HasForeignKey("BlogTypeTypeId");
                });
            ...
            modelBuilder.Entity("Schools.Domain.Models.Schools.School", b =>
                {
                    b.HasOne("Schools.Domain.Models.Schools.Locations.Area", "Area")
                        .WithMany("Schools")
            ...
            modelBuilder.Entity("Schools.Domain.Models.Schools.SchoolComment", b =>
                {
                    b.HasOne("Schools.Domain.Models.Schools.SchoolComment", null)
                        ...
                        .HasForeignKey("SchoolCommentCommentId");

                    b.HasOne("Schools.Domain.Models.Schools.School", null)
                        .WithMany("SchoolComments")
